            ...
            <div class="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        ...
                        View on Github. <a href="https://github.com/ehsan-bahrami/fruityvice" class="font-semibold text-indigo-600"><span
                                class="absolute inset-0" aria-hidden="true" />Read more <span
                                aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Demo Fruityvice</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">It's a web application powered by Symfony as the backend and Vue.js as the frontend.</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="/fruit"
                            class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get
                            started</a>
                        <a href="https://github.com/ehsan-bahrami/fruityvice" class="text-sm font-semibold leading-6 text-gray-900">Learn more <span
